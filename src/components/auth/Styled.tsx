...
export const SignInContainer = styled.div<{ signinIn: boolean }>`
  ...
  z-index: 2;
  ${({ signinIn }) =>
    signinIn !== true ? `transform: translateX(100%);` : null}
`;
...
export const Overlay = styled.div<{ signinIn: boolean }>`
  ...
  transition: transform 0.6s ease-in-out;
  ${({ signinIn }) =>
    signinIn !== true ? `transform: translateX(50%);` : null}
`;

export const OverlayPanel = styled.div<{ signinIn: boolean }>`
  position: absolute;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const LeftOverlayPanel = styled(OverlayPanel)`
  ...
  ${({ signinIn }) => (signinIn !== true ? `transform: translateX(0);` : null)}
`;
...
export const RightOverlayPanel = styled(OverlayPanel)<{ signinIn: boolean }>`
  ...
  transform: translateX(0);
  ${({ signinIn }) =>
    signinIn !== true ? `transform: translateX(20%);` : null}
`;
